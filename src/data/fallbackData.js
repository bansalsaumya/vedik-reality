...
export const FALLBACK_PROJECTS = [
  {
    ...
    title: 'Anandam Awaas & Anandam Estate',
...
export const FALLBACK_LOCATIONS = [
  {
    id: 1,
    name: 'Sector 19 & 24 Dharuhera',
    slug: 'sector-19-24-dharuhera',
    property_count: 35,
    image: '/anandam/gate.jpg',
    description: 'Home to Anandam Awaas & Anandam Estate 71-acre township with residential and commercial plots.'
  },
  {
    id: 2,
...
export const FALLBACK_SERVICES = [
  ...
  {
    id: 2,
    title: 'Commercial SCO Advisory',
    description: 'Strategic retail shops and SCO commercial plots in Sector 19 & 24 Dharuhera for high rental yields.',
    icon: 'Building'
  },
  {
    id: 3,
    title: 'Investment Portfolio Advisory',
    description: 'Data-backed real estate insights helping investors achieve maximum capital growth near NH-48 & Gurugram.',
    icon: 'TrendingUp'
  },
  {
    id: 4,
    title: 'Property Legal & Registry Support',
    description: 'End-to-end legal title check, revenue verification, mutation (दाखिल ख़ारिज), and hassle-free registry assistance.',
    icon: 'ShieldCheck'
  }
];
...
export const FALLBACK_TESTIMONIALS = [
  {
    id: 1,
    client_name: 'Rajesh Kumar (Delhi NCR Investor)',
    location: 'Sector 19, Dharuhera',
    property_purchased: 'Anandam Estate 200 Sq. Yd Plot',
    content: 'Vedik Reality guided us perfectly in selecting a plot in Anandam Estate Sector 19 Dharuhera. The entire process from site visit to registry was completely transparent and smooth.',
    rating: 5
  },
  {
    id: 2,
